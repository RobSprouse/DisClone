...
function Footer() {
     return (
          <footer className="flex flex-row items-center justify-end bg-teal-100 rounded-lg dark:bg-sky-950 dark:text-teal-100 mt-4 h-9 
          gap-5">
               <p>Created by: </p>
               ...
               <p>
            <span className="copyright-text text-black">&copy; {new Date().getFullYear()} All rights reserved.</span>
          </p>
          </footer>
     );
}
